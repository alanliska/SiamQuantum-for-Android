...
static void greeting(FILE *outFile){
	...
	"|| T. Chachiyo et al., (2016) \"Siam Quantum: a compact     |\n"
	"|| open-source quantum simulation software for molecules,\" |\n"
	"|| Thailand. see https://sites.google.com/site/siamquantum |\n"
	"||                                                         |\n"
	"|| Version: %7s                                        |\n"
	"||                                                         |\n"
	"|| Supported by (2017-present)                             |\n"
	...
	"+----------------------------------------------------------+\n"
	"                                                            \n"
	" Copyright (C) 2012-2020 Teepanis Chachiyo and Hathaithip Chachiyo  \n"
	"                                                                    \n"
	"This program is free software; you can redistribute it and/or modify\n"
	"it under the terms of the GNU General Public License as published by\n"
	"the Free Software Foundation; either version 2, or (at your option) \n"
  ...
  "                                                                    \n"
	"                                                                    \n"
	"Version for Android (aarch64, pie)                                  \n"
	"was compiled with help of high performance OPENBLAS and XC          \n"
	"libraries by Alan Liska & Veronika Ruzickova                        \n"
